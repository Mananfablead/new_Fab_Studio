          ...
          >
              ...
              <div className="flex-1">
                <div className="flex items-center gap-4">
                  ...
                  <div className="text-left">
                    <h2 className="text-xl font-bold text-foreground">Delete Group?</h2>
            ...
            <div className="flex gap-3 pt-2">
              ...
              <button
                onClick={onConfirm}
                disabled={isLoading}
                className="flex-1 px-6 py-3.5 rounded-xl bg-red-500 text-white font-semibold shadow-lg hover:opacity-90 disabled:opacity-50 flex items-center justify-center gap-2 transition-all active:scale-[0.98]"
              >
                {isLoading ? (
                  <>
